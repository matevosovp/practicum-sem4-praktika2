...
EDA оформлен в [notebooks/01_eda.ipynb](/home/what/praktika/practicum-sem4-praktika2/notebooks/01_eda.ipynb) как самостоятельный review-ready артефакт. Ключевые инженерные выводы:
...
- ноутбуки являются самостоятельными артефактами и используют уже рассчитанные parquet/json-данные, без обязательного повторного тяжелого preprocessing при открытии
